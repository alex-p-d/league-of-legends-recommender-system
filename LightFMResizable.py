"""
This extension of LightFM by https://github.com/JohnPaton
provides a fix for user/item cold start problems resizing the model to be able
to accept new users and item data without throwing errors. 
"""
